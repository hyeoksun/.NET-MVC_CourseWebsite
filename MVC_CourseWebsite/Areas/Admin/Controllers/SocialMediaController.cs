    ...
    public class SocialMediaController : BaseController
    {
        ...
        public ActionResult UpdateSocialMedia(SocialMediaDTO model)
        {
            ...
            else
            {
                ...
                if (model.SocialImage != null)
                {
                    if (System.IO.File.Exists(Server.MapPath("~/Area/Admin/Content/SocialMediaImages/" + oldImagePath)))
                    {
                        System.IO.File.Delete(Server.MapPath("~/Area/Admin/Content/SocialMediaImages/" + oldImagePath));
                    }
                }
